...
import com.phoenixjcam.xml.controller.dynamic.XmlDynamicController;
...
public class WebConfigurer extends WebMvcConfigurerAdapter
{
	...
	public SessionFactory sessionFactory()
	{
		...
		builder.scanPackages("com.phoenixjcam.xml.chart.model").addProperties(getHibernateProperties());
